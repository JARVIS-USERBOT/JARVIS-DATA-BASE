...
BOT_IS_UP_TO_DATE = "**The JARVIS-BOT** is up-to-date sir."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your JARVIS-BOT ..."
)
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("`BOT GOING TO UPDATE`")
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(
        "JARVIS-BOT UPDATING AFTER 4-5 MINS TYPE .up TO CHECK I AM ALIVE OR NOT"
    )
