...
BOT_IS_UP_TO_DATE = "**The JARVISBOT** is up-to-date sir."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your JARVISBOT ..."
)
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("`⚡Pl wait JARVIS is on update⚡`")
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(
        "⚡JARVIS-USERBOT⚡ 𝙸𝚜 𝚘𝚗 𝚞𝚙𝚍𝚊𝚝𝚒𝚗𝚐 𝚝𝚘 𝚕𝚊𝚝𝚎𝚜𝚝 ⚡version 1.0⚡ !!!\n𝚊𝚏𝚝𝚎𝚛 5 𝚖𝚒𝚗 𝚝𝚢𝚙𝚎 `.help` οя `.up` το ϲнєϲκ ιƒ ι αм οи ѕιя ♣️"
    )
